...
>
> REF-001 ya cuenta con archivo real de referencia en docs/visual-references/nelzzon-dashboard.html. REF-002 a REF-006 siguen pendientes de archivo real antes de implementar UI final basada en esas referencias.
