...
// "Configuración" se muestra aparte, anclada al pie del menú expandido —
// junto a "Personalizar" — para distinguirla del menú operativo principal.
...
export function AppSidebar({ roleKey, orgName, collapsed, onToggleCollapse, onOpenPersonalization }: AppSidebarProps) {
  ...
  // Rail mínima: el sidebar cerrado deja de listar todo el menú (eso ya lo cubre
  // el dock inferior) y se reduce a marca + control de expansión + dónde estás parado.
  if (collapsed) {
