...
// ============================================================
// FASE 1M-F — Estudio visual simple: tipos de negocio, estilos,
// paletas de color y nombres simples para tarjetas/menú inferior.
// Todo esto se traduce internamente a las plantillas y estilos de
// arriba — el usuario solo ve nombres y vistas previas, no términos
// técnicos.
// ============================================================
...
export const BUSINESS_TYPE_GROUPS: BusinessTypeGroup[] = [
  {
    ...
    label: "Salud",
    options: [
      { key: "dental", label: "Dental", templateId: "dental-premium" },
      { key: "medico", label: "Médico", templateId: "clinico-limpio" },
      { key: "clinica", label: "Clínica", templateId: "clinico-limpio" },
      { key: "psicologia", label: "Psicología", templateId: "minimal-premium" },
      { key: "nutricion", label: "Nutrición", templateId: "wellness-fitness" },
      { key: "fisioterapia", label: "Fisioterapia", templateId: "wellness-fitness" },
      { key: "veterinaria", label: "Veterinaria", templateId: "clinico-limpio" },
    ],
  },
  {
    key: "belleza",
    label: "Belleza",
    options: [
      { key: "estetica", label: "Estética", templateId: "estetica-belleza" },
      { key: "spa", label: "Spa", templateId: "estetica-belleza" },
      { key: "barberia", label: "Barbería", templateId: "creativo-moderno" },
      { key: "salon", label: "Salón", templateId: "estetica-belleza" },
      { key: "unas", label: "Uñas", templateId: "estetica-belleza" },
      { key: "dermatologia-estetica", label: "Dermatología estética", templateId: "dental-premium" },
    ],
  },
  {
    key: "servicios",
    label: "Servicios",
    options: [
      { key: "taller", label: "Taller", templateId: "taller-tecnico" },
      { key: "reparacion", label: "Reparación", templateId: "taller-tecnico" },
      { key: "mantenimiento", label: "Mantenimiento", templateId: "taller-tecnico" },
      { key: "limpieza", label: "Limpieza", templateId: "taller-tecnico" },
      { key: "instalacion", label: "Instalación", templateId: "taller-tecnico" },
      { key: "soporte-tecnico", label: "Soporte técnico", templateId: "taller-tecnico" },
    ],
  },
  {
    key: "profesional",
    label: "Profesional",
    options: [
      { key: "legal", label: "Legal", templateId: "ejecutivo-legal" },
      { key: "contable", label: "Contable", templateId: "ejecutivo-legal" },
      { key: "consultoria", label: "Consultoría", templateId: "ejecutivo-legal" },
      { key: "arquitectura", label: "Arquitectura", templateId: "ejecutivo-legal" },
      { key: "inmobiliaria", label: "Inmobiliaria", templateId: "ejecutivo-legal" },
      { key: "family-office", label: "Family office", templateId: "ejecutivo-legal" },
    ],
  },
  {
    key: "educacion",
    label: "Educación",
    options: [
      { key: "escuela", label: "Escuela", templateId: "educacion" },
      { key: "cursos", label: "Cursos", templateId: "educacion" },
      { key: "academia", label: "Academia", templateId: "educacion" },
      { key: "clases", label: "Clases", templateId: "educacion" },
    ],
  },
  {
    key: "comercio",
    label: "Comercio",
    options: [
      { key: "retail", label: "Retail", templateId: "retail-comercio" },
      { key: "restaurante", label: "Restaurante", templateId: "retail-comercio" },
      { key: "cafeteria", label: "Cafetería", templateId: "retail-comercio" },
      { key: "tienda", label: "Tienda", templateId: "retail-comercio" },
      { key: "ecommerce", label: "E-commerce", templateId: "retail-comercio" },
    ],
  },
  {
    key: "bienestar",
    label: "Bienestar",
    options: [
      { key: "gimnasio", label: "Gimnasio", templateId: "wellness-fitness" },
      { key: "wellness", label: "Wellness", templateId: "wellness-fitness" },
      { key: "yoga", label: "Yoga", templateId: "wellness-fitness" },
      { key: "entrenamiento", label: "Entrenamiento", templateId: "wellness-fitness" },
    ],
  },
  {
    key: "creativo",
    label: "Creativo",
    options: [
      { key: "agencia", label: "Agencia", templateId: "creativo-moderno" },
      { key: "diseno", label: "Diseño", templateId: "creativo-moderno" },
      { key: "marketing", label: "Marketing", templateId: "creativo-moderno" },
      { key: "fotografia", label: "Fotografía", templateId: "creativo-moderno" },
    ],
  },
  {
    key: "otro",
    label: "Otro",
    options: [{ key: "no-encuentro", label: "No encuentro mi negocio", templateId: "minimal-premium" }],
  },
];

// ----- Paso 2: estilo (10 opciones, independiente del negocio) -----

export type SimpleStyleId =
  | "limpio"
  | "premium"
  | "elegante"
  | "colorido"
...
export interface SimpleStyleOption {
  key: SimpleStyleId;
  label: string;
  description: string;
  overrides: Partial<
    Pick<
      VisualPreferences,
      "cardStyle" | "shadow" | "radius" | "density" | "dashboardCardStyle" | "dockStyle" | "dockSize" | "dockLabelVisibility" | "backgroundStyle"
    >
  >;
}

export const STYLE_OPTIONS: SimpleStyleOption[] = [
  { key: "limpio", label: "Limpio", description: "Blanco, simple y fácil de leer.", overrides: { cardStyle: "flat", shadow: "soft", radius: "soft", density: "comfortable", dashboardCardStyle: "limpia", dockStyle: "limpio" } },
  { key: "premium", label: "Premium", description: "Tarjetas flotantes con más profundidad.", overrides: { cardStyle: "floating", shadow: "elevated", radius: "rounded", density: "comfortable", dashboardCardStyle: "premium", dockStyle: "flotante-premium" } },
  { key: "elegante", label: "Elegante", description: "Sobrio, espacioso y con bordes finos.", overrides: { cardStyle: "bordered", shadow: "soft", radius: "square", density: "spacious", dashboardCardStyle: "ejecutiva", dockStyle: "ejecutivo" } },
  { key: "colorido", label: "Colorido", description: "Vivo y expresivo, con mucho color.", overrides: { cardStyle: "floating", shadow: "elevated", radius: "rounded", density: "comfortable", dashboardCardStyle: "intensa", dockStyle: "app-moderna" } },
  { key: "moderno", label: "Moderno", description: "Estilo app actual, translúcido y suave.", overrides: { cardStyle: "floating", shadow: "glass", radius: "rounded", density: "comfortable", dashboardCardStyle: "glass", dockStyle: "app-moderna" } },
  { key: "minimalista", label: "Minimalista", description: "Mucho espacio, casi sin sombra.", overrides: { cardStyle: "flat", shadow: "soft", radius: "soft", density: "spacious", dashboardCardStyle: "limpia", dockStyle: "minimal" } },
  { key: "pastel-suave", label: "Suave pastel", description: "Colores suaves tipo pastel.", overrides: { cardStyle: "floating", shadow: "soft", radius: "rounded", density: "comfortable", dashboardCardStyle: "pastel", dockStyle: "app-moderna" } },
  { key: "fuerte-operativo", label: "Fuerte operativo", description: "Sólido y directo, para trabajo diario.", overrides: { cardStyle: "bordered", shadow: "soft", radius: "square", density: "compact", dashboardCardStyle: "taller", dockStyle: "compacto" } },
  { key: "oscuro", label: "Oscuro", description: "Tono oscuro tipo vidrio.", overrides: { cardStyle: "glass", shadow: "glass", radius: "rounded", density: "comfortable", dashboardCardStyle: "glass", dockStyle: "glass", backgroundStyle: "intense" } },
  { key: "divertido", label: "Divertido", description: "Alegre, con color y formas redondeadas.", overrides: { cardStyle: "floating", shadow: "elevated", radius: "rounded", density: "comfortable", dashboardCardStyle: "intensa", dockStyle: "app-moderna" } },
];

// ----- Colores: paletas con nombre, no chips técnicos -----
...
export interface ColorPalette {
  ...
  accent: VisualAccent;
  backgroundPresetId: string;
  /** 5 colores visibles para mostrar la paleta. */
  swatches: string[];
}

export const COLOR_PALETTES: ColorPalette[] = [
  { key: "azul-clinico", label: "Azul clínico", accent: "teal", backgroundPresetId: "clinico-azul", swatches: ["#eef6ff", "#bae6fd", "#38bdf8", "#0284c7", "#0c4a6e"] },
  { key: "menta-dental", label: "Menta dental", accent: "teal", backgroundPresetId: "clinico-menta", swatches: ["#eafff5", "#99f6e4", "#2dd4bf", "#0d9488", "#134e4a"] },
  { key: "rosa-estetica", label: "Rosa estética", accent: "rose", backgroundPresetId: "estetica-rosa", swatches: ["#fff1f5", "#fecdd3", "#fb7185", "#e11d48", "#881337"] },
  { key: "negro-ejecutivo", label: "Negro ejecutivo", accent: "slate", backgroundPresetId: "ejecutivo-grafito", swatches: ["#f4f4f5", "#d4d4d8", "#71717a", "#3f3f46", "#18181b"] },
  { key: "naranja-taller", label: "Naranja taller", accent: "amber", backgroundPresetId: "taller-naranja", swatches: ["#fff4ec", "#fed7aa", "#fb923c", "#ea580c", "#7c2d12"] },
  { key: "pastel-educacion", label: "Pastel educación", accent: "violet", backgroundPresetId: "edu-azul", swatches: ["#eef6ff", "#c7d2fe", "#a5b4fc", "#818cf8", "#4338ca"] },
  { key: "verde-wellness", label: "Verde wellness", accent: "emerald", backgroundPresetId: "intenso-esmeralda", swatches: ["#f0fdf4", "#bbf7d0", "#4ade80", "#16a34a", "#14532d"] },
  { key: "morado-creativo", label: "Morado creativo", accent: "violet", backgroundPresetId: "degradado-aurora", swatches: ["#f5f0ff", "#ddd6fe", "#a78bfa", "#7c3aed", "#4c1d95"] },
  { key: "arena-premium", label: "Arena premium", accent: "amber", backgroundPresetId: "clean-arena", swatches: ["#fdf6ec", "#f5e8d3", "#e7d2ae", "#c9a876", "#8a6d3b"] },
  { key: "oscuro-moderno", label: "Oscuro moderno", accent: "slate", backgroundPresetId: "glass-oscuro", swatches: ["#f1f5f9", "#94a3b8", "#475569", "#1e293b", "#0f172a"] },
];

// ----- Tarjetas: nombres simples sobre DASHBOARD_CARD_STYLES -----

export type SimpleCardStyleId = "limpias" | "icono-grande" | "coloridas" | "tipo-app" | "glass" | "elegantes" | "compactas" | "fuertes";

export const SIMPLE_CARD_STYLES: { key: SimpleCardStyleId; label: string; description: string; dashboardCardStyle: DashboardCardStyle }[] = [
  { key: "limpias", label: "Limpias", description: "Tarjetas blancas, simples y legibles.", dashboardCardStyle: "limpia" },
  { key: "icono-grande", label: "Icono grande", description: "El icono destaca más en cada tarjeta.", dashboardCardStyle: "elevada" },
  { key: "coloridas", label: "Coloridas", description: "Tarjetas vivas, con más color.", dashboardCardStyle: "intensa" },
  { key: "tipo-app", label: "Tipo app", description: "Color sólido, estilo app móvil.", dashboardCardStyle: "solida" },
  { key: "glass", label: "Glass", description: "Vidrio translúcido y suave.", dashboardCardStyle: "glass" },
  { key: "elegantes", label: "Elegantes", description: "Sobrias, con tipografía cuidada.", dashboardCardStyle: "ejecutiva" },
  { key: "compactas", label: "Compactas", description: "Limpias y pensadas para clínicas.", dashboardCardStyle: "clinica" },
  { key: "fuertes", label: "Fuertes", description: "Directas, para uso operativo diario.", dashboardCardStyle: "taller" },
];

// ----- Menú inferior: nombres simples sobre DOCK_STYLES -----

export type SimpleDockStyleId = "simple" | "glass" | "flotante" | "compacto" | "moderno" | "sin-texto" | "iconos-grandes";

export const SIMPLE_DOCK_STYLES: {
  key: SimpleDockStyleId;
  label: string;
  description: string;
  dockStyle: DockStyle;
  dockSize: DockSize;
  ...
  { key: "simple", label: "Simple", description: "Menú limpio con iconos y texto.", dockStyle: "limpio", dockSize: "normal", dockLabelVisibility: "visible" },
  { key: "glass", label: "Glass", description: "Vidrio translúcido.", dockStyle: "glass", dockSize: "normal", dockLabelVisibility: "visible" },
  { key: "flotante", label: "Flotante", description: "Flota sobre el contenido, con sombra.", dockStyle: "flotante-premium", dockSize: "normal", dockLabelVisibility: "visible" },
  { key: "compacto", label: "Compacto", description: "Más pequeño, ahorra espacio.", dockStyle: "compacto", dockSize: "compacto", dockLabelVisibility: "visible" },
  { key: "moderno", label: "Moderno", description: "Estilo app actual.", dockStyle: "app-moderna", dockSize: "normal", dockLabelVisibility: "visible" },
  { key: "sin-texto", label: "Sin texto", description: "Solo iconos, sin etiquetas.", dockStyle: "minimal", dockSize: "normal", dockLabelVisibility: "oculto" },
  { key: "iconos-grandes", label: "Iconos grandes", description: "Iconos más grandes y fáciles de tocar.", dockStyle: "color-solido", dockSize: "grande", dockLabelVisibility: "visible" },
];
...
interface VisualPreferencesContextValue {
  ...
  // FASE 1M-F — Estudio visual simple.
  /** Aplica una paleta de colores con nombre (acento + fondo). */
  applyColorPalette: (key: ColorPaletteId) => void;
  /** Aplica un estilo con nombre (tarjetas, sombra, radio, densidad, dock). */
  applyStyleOption: (key: SimpleStyleId) => void;
  /** Aplica un estilo simple de tarjetas del Dashboard. */
  applySimpleCardStyle: (key: SimpleCardStyleId) => void;
  /** Aplica un estilo simple del menú inferior. */
  applySimpleDockStyle: (key: SimpleDockStyleId) => void;
}
...
export function VisualPreferencesProvider({ children }: { children: ReactNode }) {
  ...
  const value: VisualPreferencesContextValue = {
    ...
    applyColorPalette: (key) => {
      ...
      if (!palette) return;
      update({ accent: palette.accent, backgroundPresetId: palette.backgroundPresetId });
    },
    applyStyleOption: (key) => {
      const style = STYLE_OPTIONS.find((s) => s.key === key);
      if (!style) return;
      update(style.overrides);
    },
    applySimpleCardStyle: (key) => {
      const style = SIMPLE_CARD_STYLES.find((s) => s.key === key);
      if (!style) return;
      update({ dashboardCardStyle: style.dashboardCardStyle });
    },
    applySimpleDockStyle: (key) => {
      const style = SIMPLE_DOCK_STYLES.find((s) => s.key === key);
      if (!style) return;
      update({ dockStyle: style.dockStyle, dockSize: style.dockSize, dockLabelVisibility: style.dockLabelVisibility });
    },
  };
