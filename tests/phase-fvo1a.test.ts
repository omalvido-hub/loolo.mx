...
describe("integridad de archivos FVO-1a", () => {
  ...
  it("no existe migración 0023 ni superior (snapshot: FVO-1a no creó más allá de 0017; 0018-0019 son de fases posteriores legítimas; 0020 es de 1I-D-3 — cobertura/aseguradora)", () => {
    const files = readdirSync(resolve("prisma/migrations"));
